%+----------------------------------------------------------------------------+
%| Main-File: standard-model-Burgard.tex
%| Contents:  Diagram of the Standard Model of particle physics
%|
...
%|
%| Description: 
%|   This file contains a LaTeX implementation of the Standard Model diagram, 
%|   programmed using TikZ. The diagram was created during the CERN Webfest 2012 
%|   by David Galbraith and Carsten Burgard to visually represent the fundamental 
%|   particles and their interactions in the Standard Model.
%|
%| Source: 
%|   The diagram and its details can be found at: 
